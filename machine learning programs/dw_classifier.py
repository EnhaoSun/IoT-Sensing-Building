...
############################################################################
input_file_train = 'window_train.csv'
...
############################################################################
input_file_test = 'window_test.csv'
...
print(test_score)
joblib.dump(clf, 'windowACC.pkl')


"""

# after using grid search
# window {'C': 1000, 'kernel': 'rbf'}
# door {'C': 100, 'kernel': 'linear'}

clf = SVC(C=100.0, kernel='linear', random_state = 12)
clf.fit(x_train, y_train)
test_score = clf.score(x_test, y_test)
print(test_score)
